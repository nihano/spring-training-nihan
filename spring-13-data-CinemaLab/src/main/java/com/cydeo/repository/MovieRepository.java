...
public interface MovieRepository extends JpaRepository<Movie, Long> {
    ...
    List<Movie> findAllByDurationIn(List<Integer> duration); //In for list
    ...
    @Query("SELECT m FROM Movie m WHERE m.price BETWEEN ?1 AND ?1")
    List<Movie> fetchAllBetweenPriceRange(@Param("price2") BigDecimal price1, @Param("price2") BigDecimal price2);
